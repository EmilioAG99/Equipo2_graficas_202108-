...
Trunc = function(complex){
  ...
  this.truncStartRadius = Math2.rangeRandom(2,4); 
  this.verticalSegments = Math2.rangeRandomInt(3,5);
  this.radiusSegments = Math2.rangeRandomInt(4,6);
  ...
  this.noise = Math2.rangeRandom(this.truncStartRadius/8, this.truncStartRadius/4);
